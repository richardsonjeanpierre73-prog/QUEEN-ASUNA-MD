...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "INCONNU~XD~C84W0QbL#d_7vVzofleUPeSdqUf4Wc_-7snut0CWS5vEtwW9tot8",
...
BOT_NAME: process.env.BOT_NAME || "Mme Fayoo and Mr kenley ",
STICKER_NAME: process.env.STICKER_NAME || "Fayoo madan kenley",
CUSTOM_REACT: process.env.CUSTOM_REACT || "false", 
CUSTOM_REACT_EMOJIS: process.env.CUSTOM_REACT_EMOJIS || "💝,💖,💗,❤️‍🩹,❤️,🧡,💛,💚,💙,💜,🤎,🖤,🤍",
DELETE_LINKS: process.env.DELETE_LINKS || "false",
OWNER_NUMBER: process.env.OWNER_NUMBER || "50940023978",
OWNER_NAME: process.env.OWNER_NAME || "Fayoo madan kenley",
